    ...
    <div class="col s12 m6">
      <div class="card ticket-card" data-ticket-id="${ticket.id}">
        <div class="ticket-airline d-flex align-items-center justify-items-between">
          <div class="ticket-airline_logo">
          <img src="${ticket.airline_logo}" class="ticket-airline-img" />
          <span class="ticket-airline-name d-block">${ticket.airline_name}</span>
          </div>
          <div class="ticket-airline__favorites cursorPoint">
            <span><i class="material-icons">${ticket.isFavorites ? 'favorite' : 'favorite_border'}</i></span>
          </div>
        </div>
